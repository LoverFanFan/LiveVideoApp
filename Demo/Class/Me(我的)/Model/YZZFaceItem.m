...
@synthesize m_classNum;
@synthesize m_timeDic;
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:m_classNum     forKey:kClassNum];
    [aCoder encodeObject:m_timeDic      forKey:kTimeDic];
}
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self == [super init])
    {
        ...
        m_classNum  = [aDecoder decodeObjectForKey:kClassNum];
        m_timeDic   = [aDecoder decodeObjectForKey:kTimeDic];
    }
    return self;
}
...
- (id)copyWithZone:(NSZone *)zone
{
    ...
    copy.m_classNum     = [self.m_classNum  copyWithZone:zone];
    copy.m_timeDic      = [self.m_timeDic   copyWithZone:zone];
    return copy;
}
